...
window.Meta.Template.filter = function(name, key){
	...
	return function(context){
		...
		this.innerHTML = window.Meta.Template.filters[name].call(this, window.Meta.Template._value(this, context, key), context);
...
window.Meta.Template.property = function(name, key){
	...
	return function(context){
		this[name] = (key ? window.Meta.Template._value(this, context, key) : context.data);
	}
